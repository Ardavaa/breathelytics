...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const mobileMenuBtnn = document.createElement('button');
    mobileMenuBtnn.classList.add('mobile-menu-btn');
    mobileMenuBtnn.innerHTML = `
    ...
    // Menangani klik pada tautan menu
